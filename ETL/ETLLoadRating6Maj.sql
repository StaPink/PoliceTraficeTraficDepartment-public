...
FROM
    ...
    Join Police.dbo.Criminal   as ST4 ON ST4.criminal_ID = ST4.ID
	...
	--te tabele juz sa nie musisz ich wrzucac robisz jak w junku w przykladzie

    --criminal
	JOIN dbo.Criminal as Criminal ON criminal.ID = ST4.ID 

    --policeman
	JOIN dbo.Policeman as Policeman ON Policeman.badge_number = ST2.badge_number 

	--ticket
	JOIN dbo.Ticket as Ticket ON Ticket.ticket_id = ST3.ID
    )
go
